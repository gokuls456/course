...
const CardV2 = ({ info: { title, imageUrl, smallDescription, date, time } }) => {
    return (
        <Card style={{ width: '18rem', cursor: 'pointer' }}>
            ...
            <Card.Body>
                ...
                <Button className='card-button orange-round-button'><i className='fas fa-play p-3' />GET EVENT</Button>
            </Card.Body>
        </Card>
    );
}
